...
## Milestones
1. Docs, notebook skeleton, reusable split and pairing utilities
2. Patient-level BreaKHis baseline and outputs
3. Wisconsin review and synthetic pairing construction
4. Fusion experiments, control experiments, and final results pack
5. Transfer-ready inference artifacts and final documentation
